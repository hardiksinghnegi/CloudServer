SECURA SERVER is a PHP CODEINGITER  based project which exposes REST APIs to perform transfer of files to common 3rd Party Storage Infrastructure securely.
